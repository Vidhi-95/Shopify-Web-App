...
<%@include file="/WEB-INF/views/template/header.jsp" %>
    ...
    <h1>Add Product!</h1>
    <p class="lead">Give details here to add new Products</p>
    </div>
  ...
  <!--    <div class="form-group">
   ...
   <form:input type="text" class="form-control"	path="productId" id="Id"/>
   </div> --> 
   
   <div class="form-group">
   <label for="name">Name</label> <form:errors path="productName" cssStyle="color: #ff0000;" />
   <form:input type="text" placeholder="Enter Product Name.." class="form-control"	path="productName" id="name"/>
   </div>
   <div class="form-group">
   ...
   <form:textarea type="text" placeholder="Enter Product Description.." class="form-control" path="productDescription" id="description"/>
   </div>
   	
   <div class="form-group">
   <label for="price">Price</label> <form:errors path="productPrice" cssStyle="color: #ff0000;" />
   <form:input type="text" placeholder="Enter Price" class="form-control" path="productPrice" id="price"/>
   </div>
   ...
   <div class="form-group">
	...
	<div class="form-group">
						...
						<form:input type="text" placeholder="Enter units" class="form-control" path="unitInStock" id="unitInStock"/>		 
	</div>
	<div class="form-group">
						<label for="manufacturer">Manufacturer</label>
						<form:input type="text" placeholder="Enter Manufacturer" class="form-control" path="productManufacturer" id="manufacturer"/>		 
	</div>
